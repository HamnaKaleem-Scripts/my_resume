...
const SkillsList = () => {
  ...
  const skills = {
    "Predictive Analytics": [
      "Build predictive models using regression and time series",
      "Forecast future outcomes with historical data",
    ],
    "Data Analysis & Visualization": [
      "Analyze data for trends and insights",
      "Create visuals using Tableau, Power BI, and Python",
    ],
    "Data Engineering": [
      "Build data pipelines for cleaning and structuring data",
      "Manage databases (SQL/NoSQL) for large datasets",
    ],
  };
